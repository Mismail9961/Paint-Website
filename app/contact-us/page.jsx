    ...
    <div>
      <main className="max-w-6xl mx-auto px-6 py-12 bg-white text-[#2F3C50]">
        ...
        <section className="mt-12 rounded-2xl border p-6 bg-white shadow-sm">
          ...
          <p className="mt-2 text-sm text-[#2F3C50]/80">
            Prefer phone or live chat? Use the channels below.
          </p>

          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <a
              className="flex items-start gap-3 p-4 rounded-lg border border-[#2F3C50] hover:shadow-sm"
              href="tel:+923001234567"
            >
              <Phone className="w-6 h-6 text-[#2F3C50]" />
              <div>
                <p className="font-medium">Call us</p>
                <p className="text-sm text-[#2F3C50]/80">+92 300 1234567</p>
              </div>
            </a>
            ...
            >
              <Mail className="w-6 h-6 text-[#2F3C50]" />
              <div>
                <p className="font-medium">Email</p>
                <p className="text-sm text-[#2F3C50]/80">support@yourecommercesite.com</p>
              </div>
            </a>
            ...
            <a
              ...
              href="/live-chat"
            >
              <MapPin className="w-6 h-6 text-[#2F3C50]" />
              <div>
                <p className="font-medium">Live chat</p>
                <p className="text-sm text-[#2F3C50]/80">Available during business hours</p>
              </div>
            </a>
          </div>
        </section>
